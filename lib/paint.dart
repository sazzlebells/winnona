...
class WavePaint extends StatelessWidget {
  @override
...
class CurvePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint.color = Color.fromARGB(300, 168, 203, 253);
    ...
    paint.color = Color.fromARGB(650, 168, 203, 253);
    canvas.drawPath(path, paint);
    ...
    paint.color = Color.fromARGB(950, 168, 203, 253);
    canvas.drawPath(path, paint);
  }
